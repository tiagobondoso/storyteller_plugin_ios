...
Storyteller.showStoriesRowView = function(categories, successCallback, errorCallback) {
    if (!options || typeof options !== "object") {
        options = {};
    }
    return execPromise('showStoriesRowView', categories, successCallback, errorCallback);
};
