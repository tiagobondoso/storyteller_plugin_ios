...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Don't instantiate a StorytellerListView directly, rather one of its final subclasses");
...
@property (nonatomic) CGSize recalculatedSize;
...
@interface StorytellerClipsGridView : StorytellerGridView
...
@interface StorytellerClipsRowView : StorytellerRowView
- (id _Nullable)awakeAfterUsingCoder:(NSCoder * _Nonnull)coder SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC14StorytellerSDK30StorytellerClipsViewController")
@interface StorytellerClipsViewController : UIViewController
...
@interface StorytellerClipsViewController (SWIFT_EXTENSION(StorytellerSDK)) <UIPageViewControllerDelegate>
...
@interface StorytellerClipsViewController (SWIFT_EXTENSION(StorytellerSDK))
- (void)resumePlayer;
@end



@interface StorytellerClipsViewController (SWIFT_EXTENSION(StorytellerSDK)) <UIPageViewControllerDataSource>
...
SWIFT_CLASS("_TtC14StorytellerSDK21StorytellerStandardAd")
@interface StorytellerStandardAd : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC14StorytellerSDK26StorytellerStoriesGridView")
@interface StorytellerStoriesGridView : StorytellerGridView
- (id _Nullable)awakeAfterUsingCoder:(NSCoder * _Nonnull)coder SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14StorytellerSDK25StorytellerStoriesRowView")
@interface StorytellerStoriesRowView : StorytellerRowView
- (id _Nullable)awakeAfterUsingCoder:(NSCoder * _Nonnull)coder SWIFT_WARN_UNUSED_RESULT;
@end
